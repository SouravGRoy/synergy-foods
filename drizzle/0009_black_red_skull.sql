...
--> statement-breakpoint
ALTER TABLE "products" ADD COLUMN "is_marketed" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "products" ADD COLUMN "marketed_at" timestamp;--> statement-breakpoint
...
CREATE INDEX "order_status_history_status_idx" ON "order_status_history" USING btree ("new_status");--> statement-breakpoint
